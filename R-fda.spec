...
Version  : 5.4.0
Release  : 42
URL      : https://cran.r-project.org/src/contrib/fda_5.4.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/fda_5.4.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1632840923
