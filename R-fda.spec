...
Version  : 2.4.7
Release  : 10
URL      : https://cran.r-project.org/src/contrib/fda_2.4.7.tar.gz
Source0  : https://cran.r-project.org/src/contrib/fda_2.4.7.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1521207452
...
R CMD check --no-manual --no-examples --no-codoc -l %{buildroot}/usr/lib64/R/library fda|| : 
cp ~/.stash/* %{buildroot}/usr/lib64/R/library/*/libs/ || :
