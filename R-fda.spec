...
Version  : 5.1.5
Release  : 29
URL      : https://cran.r-project.org/src/contrib/fda_5.1.5.tar.gz
Source0  : https://cran.r-project.org/src/contrib/fda_5.1.5.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1594676067
